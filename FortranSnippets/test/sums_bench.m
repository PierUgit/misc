...
legend('psum 1000 (raw)','psum 1000 (smooth RMS)', ...
       'location','northwest') 
print('sums_bench_files/fig10.png','-dpng','-S700,400');
...
semilogx  (nbel,sumi(:,1),'k', ...
           ...
           nbel,ksum(:,1),'b')
axis([1 1e9 0 10]);
xlabel('N'); ylabel("error"); title(["+/- distribution" ftitle]);
legend('sum','sum sp','sum dp','psum','ksum', ...
       'location','northwest') 
print('sums_bench_files/fig11.png','-dpng','-S700,400');
...
legend('psum','psum 10','psum 100','psum 1000', ...
       'location','northwest') 
print('sums_bench_files/fig12.png','-dpng','-S700,400');
...
legend('ksum','ksum 10','ksum 100','ksum 1000', ...
       'location','northwest') 
print('sums_bench_files/fig13.png','-dpng','-S700,400');
...
legend('sum','sum sp','sum dp','psum','ksum', ...
       'location','northwest') 
print('sums_bench_files/fig14.png','-dpng','-S700,400');
...
legend('psum','psum 10','psum 100','psum 1000', ...
       'location','northwest') 
print('sums_bench_files/fig15.png','-dpng','-S700,400');
...
legend('ksum','ksum 10','ksum 100','ksum 1000', ...
       'location','northwest') 
print('sums_bench_files/fig16.png','-dpng','-S700,400');
